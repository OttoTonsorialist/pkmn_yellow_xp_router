...
from route_recording.game_recorders.yellow_gamehook_constants import gh_gen_one_const, GameHookConstantConverter, RedBlueGameHookConstantConverter
...
class YellowRecorder(route_recording.recorder.RecorderGameHookClient):
    def __init__(self, controller:route_recording.recorder.RecorderGameHookClient, expected_name:str):
        ...
        self._machine.register(route_recording.game_recorders.yellow_states.InventoryChangeState(self._machine))

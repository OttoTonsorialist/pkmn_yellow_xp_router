...
namespace eval ttk::theme::azure-dark {
    ...
    ttk::style theme create azure-dark -parent clam -settings {
        ...
        ttk::style layout Wide.Vertical.TScrollbar {
            Wide.Vertical.Scrollbar.trough -sticky ns -children {
                Wide.Vertical.Scrollbar.thumb -expand true
            }
        }
        ...
        # Custom mon labels/frames
        ttk::style configure Inventory.TFrame -background $colors(-contrast)
        ttk::style configure Inventory.TLabel -background $colors(-contrast)
        ttk::style configure Header.TFrame -background $colors(-header)
        ttk::style configure Header.TLabel -background $colors(-header) -anchor center
        ttk::style configure Primary.TFrame -background $colors(-primary)
        ttk::style configure Primary.TLabel -background $colors(-primary) -anchor center
        ttk::style configure BattleMovePrimary.TLabel -background $colors(-primary) -anchor center -padding {0 4 0 4}
        ttk::style configure Secondary.TFrame -background $colors(-secondary)
        ttk::style configure Secondary.TLabel -background $colors(-secondary) -anchor center
        ttk::style configure Success.TFrame -background $colors(-success)
        ttk::style configure Success.TLabel -background $colors(-success) -anchor center
        ttk::style configure Padded.Success.TLabel -background $colors(-success) -anchor center -padding 10
        ttk::style configure Failure.TFrame -background $colors(-failure)
        ttk::style configure Failure.TLabel -background $colors(-failure) -anchor center
        ttk::style configure Warning.TFrame -background $colors(-warning)
        ttk::style configure Warning.TLabel -background $colors(-warning) -anchor center
        ttk::style configure Padded.Warning.TLabel -background $colors(-warning) -anchor center -padding 10
        ttk::style configure Contrast.TFrame -background $colors(-contrast)
        ttk::style configure Contrast.TLabel -background $colors(-contrast) -anchor center
        ttk::style configure Divider.TFrame -background $colors(-divider)
        ...
        # AccentButton
        ttk::style configure Accent.TButton -padding {2 1 2 1} -anchor center

        ttk::style element create AccentButton.button image \
            [list $I(rect-accent) \
            	{selected disabled} $I(rect-hover) \
                disabled $I(box-basic) \
        ...
        ttk::style element create Wide.Vertical.Scrollbar.trough image $I(wide-vert-basic) \
            -sticky ns

        ttk::style element create Wide.Vertical.Scrollbar.thumb \
            image [list $I(wide-vert-accent) \
                disabled  $I(wide-vert-basic) \
                pressed $I(wide-vert-hover) \
                active $I(wide-vert-hover) \
            ] -sticky ns
        ...
        # Treeview
        ttk::style configure Treeview -background $colors(-bg) -fieldbackground $colors(-bg)

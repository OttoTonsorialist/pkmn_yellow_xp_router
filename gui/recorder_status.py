...
class RecorderStatus(tk.Frame):
    def __init__(self, main_controller:MainController, recorder_controller:RecorderController, *args, **kwargs):
        ...
        self._main_controller.register_record_mode_change(self.on_recording_mode_changed)
        self._recorder_controller.register_recorder_status_change(self.on_recording_status_changed)
        self._recorder_controller.register_recorder_ready_change(self.on_recording_ready_changed)
